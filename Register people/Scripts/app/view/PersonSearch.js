Ext.define('PersonApp.view.PersonSearch', {
    ...
    items: [{
        ...
        name: 'LastName',
        maskRe: /[а-яА-Я -*ёЁ]/,
        regex:/^([а-яА-Я*ёЁ]+[ -]?[а-яА-Я*ёЁ]+)$/,
        invalidText:"Для поиска пользователей используйте символы кириллицы. " +
            "Если Фамилия двойная, то запишите через ' ' или '-'. " +
            "Для поиска всех совпадений используйте *",
        maxLength:25,
        ...
        regex:/^([а-яА-Я*ёЁ]+[ -]?[а-яА-Я*ёЁ]+)$/,
        invalidText:"Для поиска пользователей используйте символы кириллицы. " +
            "Если имя двойное, то запишите через ' ' или '-'. " +
            "Для поиска всех совпадений используйте *",
        maxLength:25,
        maxLengthText:"Введите меньше 25 символов кириллицы",
    }, {
        ...
        regex:/^([а-яА-Я*ёЁ]+[ -]?[а-яА-Я*ёЁ]+)$/,
        invalidText:"Для поиска пользователей используйте символы кириллицы. " +
            "Если Отчество двойное, то запишите через ' ' или '-'. " +
            "Для поиска всех совпадений используйте *",
        maxLength:25,
        maxLengthText:"Введите меньше 25 символов кириллицы",
    },
